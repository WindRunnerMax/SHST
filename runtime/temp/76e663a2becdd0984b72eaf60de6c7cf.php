<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"/www/wwwroot/www.open.edu-bo.top/app/index/view/sw/overview.html";i:1554885609;s:64:"/www/wwwroot/www.open.edu-bo.top/app/index/view/common/view.html";i:1554876742;}*/ ?>
﻿<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<div class="funct" onclick="location.href='<?php echo $ctx; ?>/index/sw/table'"><i class="layui-icon layui-icon-table size"></i>查课表</div>
<div class="funct" onclick="location.href='<?php echo $ctx; ?>/classroom'"><i class="layui-icon layui-icon-user size"></i>查教室</div>
<div class="funct" onclick="location.href='<?php echo $ctx; ?>/index/sw/grade'"><i class="layui-icon layui-icon-chart-screen size"></i>查成绩</div>
...
<div class="funct" onclick="location.href='<?php echo $ctx; ?>/index/sw/info'"><i class="layui-icon layui-icon-about size"></i>公告</div>
