...
### 3.5.7 (2021-06-15) [b32db09]
1. 修正一些变量定义方式
2. 修复无空教室时的异常

### 3.5.6 (2021-05-21) [c1d1607]
1. 增加泰安校区空教室查询
2. 调整字体大小等细节处理

### 3.5.5 (2021-03-23) [ade1cb6]
1. 处理课表异常报错
2. 增加实时日志调用
3. 优化校园卡样式结构

### 3.5.4 (2021-03-09) [ea8002a]
1. 增加新鲜事功能
2. 增加scss样式库
3. 调整部分提示信息
4. 修复按钮样式的兼容问题
...
### 3.5.2 (2021-01-17) [752fb97]
1. 修正文字的描述信息
2. 修复每日一句接口问题
3. 增加缓存控制对象封装
4. 广告组件加入后端控制展示

### 3.5.1 (2020-12-08) [e5c2961]
1. 修复校历抛出的异常
2. 修复自定义课表保存逻辑问题
3. 添加事件总线一次性触发订阅
4. 修复初始化失败后无法继续操作的问题

### 3.5.0 (2020-11-22) [717ef8e]
1. 解决初始化状态问题
2. 修复校历假期颜色问题
3. 自定义添加课表项目功能

### 3.4.1 (2020-10-25) [1ef3d5d]
1. 天气组件样式修正
2. 加入公告仅弹出情况
3. 处理课表新的数据结构
4. 去除教室课表与蹭课查询广告位

### 3.4.0 (2020-10-24) [bbd9c16]
1. 加入轮播图
2. 天气样式修改
3. 加入弹出式公告
4. 修复校内公告图片显示问题
