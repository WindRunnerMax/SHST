<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"/www/wwwroot/www.open.edu-bo.top/app/adapt/view/sw/grade.html";i:1554865796;s:64:"/www/wwwroot/www.open.edu-bo.top/app/adapt/view/common/view.html";i:1554877305;}*/ ?>
﻿<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<hr class="layui-bg-gray">
    ...
    <?php if($info){ foreach ($info as $value) { ?>
            <div style="padding: 6px;"><?php echo $value['zcj']; ?> <?php echo $value['kcmc']; ?> <?php echo $value['xf']; ?></div>
            <hr class="layui-bg-gray">
    <?php } } ?>
</div>
...
<script type="text/javascript">
    ...
    function loadGrade() {
        var xn = $("#sele").val();
        if (xn !== "") xn = "/" + xn;
	location.href='<?php echo $ctx; ?>/adapt/sw/grade'+xn;
    }
