<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"E:\wamp\www\Swisdom\Web/app/index\view\index\index.html";i:1559903847;s:56:"E:\wamp\www\Swisdom\Web\app\auxiliary\common\layout.html";i:1552660289;}*/ ?>
﻿<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<form id="formAct" action="<?php echo $ctx; ?>/index.php/index/sw/login" method="post">
...
<script type="text/javascript">
  ...
  (function() {
    if(localStorage.getItem('flag') === null) localStorage.setItem("flag","1");
...
<form role="form" action="<?php echo $ctx; ?>/index.php/index/sw/login" id="form" method="post">
  <fieldset>
...
function subSave(){
    ...
    localStorage.setItem("password",encodeURIComponent(document.getElementById("password").value));
    login();
}
