...
### 1.8.2 (2019-6-25) [a64d565]
1. 部分加载提示载入封装网络请求的Complete种
2. 空教室排序
3. 登陆时显示密码开关

### 1.8.2 (2019-6-24) [d813066]
1. 优化APP请求逻辑
2. 修复版本号问题

### 1.8.1 (2019-6-22) [85a5d31]
1. 登录逻辑更改
2. 优化封装网络请求

### 1.7.2 (2019-6-21) [59cecbd]
1. 查询教室功能优化

### 1.7.1 (2019-6-19) [a0b96cf]
1. 近7天空教室查询功能
2. 修复部分冗余

### 1.6.5 (2019-6-18) [e38c011]
1. 目录结构整理
2. 修复时间与登录BUG

### 1.6.4 (2019-6-16) [3f97a7b]
1. 使用Storage存储部分数据

### 1.6.3 (2019-6-15) [3c09247]
1. 更新前后端逻辑，减少对强智的请求

### 1.6.2 (2019-6-13) [74ec7d2]
1. 代码目录结构
2. user界面重构
3. 修复一些登录的问题

### 1.6.1 (2019-6-11) [ed5f91b]
1. 减少服务器负载，本地处理数据

### 1.5.2 (2019-6-9) [1b33ddf]
1. 待办安排功能

### 1.5.1 (2019-6-8) [f141520]
1. 图标颜色问题
2. 修复主页用户未授权的问题
3. 增加放假安排功能

### 1.4.5 (2019-6-7) [c59e024]
