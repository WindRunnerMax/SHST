        ...
        <view class='a-hide' :class="{'a-show':today > '2020-03-26'}">
            <layout>
                <view class="y-CenterCon">
                    ...
                    <navigator url="/pages/Home/auxiliary/webview?url=https%3A%2F%2Fmp.weixin.qq.com%2Fs%2F9L3kFI0jdHajnPm83jRbwA" open-type="navigate" class='a-link' hover-class="none">自定义课表配色</navigator>
                </view>
            </layout>
        </view>
